...
def send_report_email(to_addr: str, csv_path: str, team_name: str, date_str: str) -> None:
    ...
    *to_addr* may contain a single address or multiple comma-separated
    ...
    body = (
        ...
        f"  metrics_loc_added_by_language_total_28d      LOC applied per language: inline+chat+edit+agent, sorted by volume descending\n"
        ...
        f"  metrics_loc_suggested_by_language_agent_28d  LOC proposed per language: agent (chat_panel_agent_mode+chat_panel_plan_mode+agent_edit) only\n"
